...
export const Topbar = memo(function Topbar({ title, subtitle, showBackButton, onBackClick }: TopbarProps) {
  ...
  return (
    <header className="h-14 md:h-16 bg-navbar border-b border-border flex items-center justify-between px-3 md:px-6 sticky top-0 z-30 w-full overflow-hidden">
      {/* Left side - Title */}
      ...
      <div className="flex items-center gap-1 md:gap-2 lg:gap-4 flex-shrink-0">
        ...
        {/* Profile */}
        <div className="flex items-center gap-1 md:gap-2 lg:gap-3 pl-2 md:pl-3 lg:pl-4 border-l border-border flex-shrink-0">
          <div className="flex items-center gap-1 md:gap-2 lg:gap-3">
            <div className="w-7 h-7 md:w-8 md:h-8 bg-primary rounded-full flex items-center justify-center flex-shrink-0">
              <span className="text-primary-foreground text-xs md:text-sm font-medium">JD</span>
            </div>
